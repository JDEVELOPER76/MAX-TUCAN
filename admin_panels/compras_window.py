...
class ComprasWindow:
    def __init__(self, page: ft.Page, admin_panel):
        ...
        self.compras_data = ft.DataTable(
            ...
            rows=[],
            expand=True,
            column_spacing=150,  # Increased spacing between columns
            divider_thickness=1,
        )
        ...
        tabla_container = ft.Container(
            content=ft.Column([
                ...
                ft.Container(
                    ...
                    expand=True,
                    padding=10,  # Added padding inside table container
                )
            ], spacing=15, expand=True),  # Increased spacing between elements
        ...
        return ft.Column([
            ...
            ft.Container(
                content=ft.Row([
                    ...
                    ], spacing=15)  # Increased spacing between buttons
            ...
            # Filtros (Altura fija)
            ft.ResponsiveRow([
                ft.Container(content=self.buscar_field, col={"md": 6}, padding=10),  # Increased padding
                ft.Container(content=self.filtro_estado, col={"md": 4}, padding=10),
                ft.Container(
...
class VentanaProveedores:
    def __init__(self, page: ft.Page, win):
        ...
        self.tabla = ft.DataTable(
            ...
            rows=[],
            expand=True,
            column_spacing=20,  # Added spacing for provider table
        )
        self.construir_dialog()
    ...
    def construir_dialog(self):
        content = ft.Container(
            content=ft.Column([
                ...
                ft.Container(content=self.tabla, expand=True, padding=10)  # Added padding
    ...
    def actualizar_lista(self):
        ...
        self.tabla.rows = [
            ft.DataRow(cells=[
                ft.DataCell(ft.Container(content=ft.Text(r["nombre"]), padding=5)),  # Added padding
                ft.DataCell(ft.Container(content=ft.Text(r["contacto"] or ""), padding=5)),
                ft.DataCell(ft.Container(content=ft.Text(r["telefono"] or ""), padding=5)),
                ft.DataCell(ft.Container(content=ft.Text(r["email"] or ""), padding=5)),
                ...
                ], spacing=8), padding=5))  # Increased spacing and padding
            ]) for r in rows
        ]
        self.page.update()
